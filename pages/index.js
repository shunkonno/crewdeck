      ...
      <div className="">
            ...
            <div className="flex items-center py-md sm:py-xl">
              <div className="w-full md:w-1/2">
                <h1 className="text-4xl font-bold">
                  <p className="text-5xl leading-extra-tight lg:leading-tight">
                    Manage Bounties
                  </p>
        ...
        <section className="bg-white px-sm py-md sm:py-xl">
          <div className="max-w-5xl mx-auto">
            <div className="mb-4">
              <h2 className="inline text-2xl font-semibold leading-normal">
                Managing bounties on Discord is hard.&nbsp;
              </h2>
              <div className="relative inline-block w-6 h-6 sm:py-0">
                <Image
                  src={'/images/decoration/moyamoya.png'}
                  layout="fill"
                  alt="moyamoya"
                />
              </div>
            ...
            <p className="">
              Bad management of tasks leads to most people feeling unsure how to
              contribute.{' '}
            </p>
            <p className="mt-2">Examples: </p>
            <p className="">
              ・Checking every Discord channel to keep track of potential
              opportunities{' '}
            </p>
        ...
        <section className="bg-white px-sm py-md sm:py-xl">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl font-semibold leading-normal mb-4">
              Purpose
            </h2>
                ...
                <div className="">
                  <div className="flex flex-col md:flex-row justify-center items-center gap-2 w-full">
                    ...
                    <h3 className="text-xl font-medium text-center md:text-left">
                      Managing Bounties within the DAO
                    </h3>
                  </div>
                  <p className="mt-4">
